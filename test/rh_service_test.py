...
class RHServiceCase(unittest.TestCase):
    ...
    def test_calcularSalarioSTA(self):
        ...
        self.assertEqual(2000.0, self.rh.calcularSalarioDoFuncionario(self.cpfMiriam), 0.01, "Calculo incorreto")

    def test_calcularSalarioTerceirizados(self):
        self.assertTrue(self.rh.cadastrar(self.tercCarla))
        self.assertEqual(1000.0, self.rh.calcularSalarioDoFuncionario(self.cpfCarla), 0.01, "Calculo incorreto")
    ...
    def test_salarioProfessorComDiaria(self):
        ...
        self.assertEqual(7100.0, self.rh.calcularSalarioDoFuncionario(self.cpfJonas), 0.01, "Calculo de diaria incorreto")
    ...
    def test_salarioSTAComDiaria(self):
        ...
        self.assertEqual(1600.0, self.rh.calcularSalarioDoFuncionario(self.cpfLacerda), 0.01, "Calculo de diaria incorreto")
    ...
    def test_salarioTerceirizadoComDiaria(self):
        ...
        self.assertEqual(1000.0, self.rh.calcularSalarioDoFuncionario(self.cpfCarla), 0.01, "Calculo de diarias incorreto")

    def test_diariaAlemDoLimiteProfessor(self):
        self.assertTrue(self.rh.cadastrar(self.profJonas))
        self.assertTrue(self.rh.solicitarDiaria(self.cpfJonas), "Um professor tem direito a tres diarias")
        self.assertEqual(7100.0, self.rh.calcularSalarioDoFuncionario(self.cpfJonas), 0.01,
        ...
        self.assertEqual(7300.0, self.rh.calcularSalarioDoFuncionario(self.cpfJonas), 0.01,
                         "O calculo do salario esta incorreto")

    def test_diariaAlemDoLimiteSTA(self):
        self.assertTrue(self.rh.cadastrar(self.staLacerda))
        self.assertTrue(self.rh.solicitarDiaria(self.cpfLacerda))
        self.assertEqual(1600.0, self.rh.calcularSalarioDoFuncionario(self.cpfLacerda), 0.01,
                         "O calculo do salario esta incorreto")
    ...
    def test_calcularFolhaVazia(self):
        self.assertEqual(0.0, self.rh.calcularFolhaDePagamento(), 0.01, "Folha de pagamento esta vazia")
    ...
    def test_calcularFolha(self):
        ...
        self.assertEqual(10000.0, self.rh.calcularFolhaDePagamento(), 0.01, "Soma de salarios incorreta")

        self.assertTrue(self.rh.cadastrar(self.staLacerda))
        self.assertTrue(self.rh.cadastrar(self.profAlessio))
        self.assertTrue(self.rh.cadastrar(self.tercAdriana))

        self.assertEqual(18000.0, self.rh.calcularFolhaDePagamento(), 0.01, "Soma de salarios incorreta")
    ...
    def test_calcularFolhaComDiarias(self):
        ...
        self.assertEqual(7100.0, self.rh.calcularSalarioDoFuncionario(self.cpfJonas), 0.01,
                         "Soma de salarios com diaria incorreta")
        self.assertTrue(self.rh.solicitarDiaria(self.cpfJonas))
        self.assertTrue(self.rh.solicitarDiaria(self.cpfJonas))
        ...
        self.assertEqual(18400.0, self.rh.calcularFolhaDePagamento(), 0.01, "Soma de salarios com diaria incorreta")
    ...
    def test_calcularFolhaComPL(self):
        self.participacaoNosLucros()
        self.assertEqual(10006.0, self.rh.calcularFolhaDePagamento(), 0.01,
                         "Soma de salarios com participacao nos lucros incorreta")

    def test_iniciandoNovoMes(self):
        self.calcularFolhaComPL()
        self.rh.iniciarMes()
